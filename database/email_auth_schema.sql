-- Script de migration pour passer de téléphone à email
-- À exécuter dans phpMyAdmin

USE localloop;

-- Supprimer les anciennes contraintes et index
ALTER TABLE users DROP INDEX IF EXISTS phone;
ALTER TABLE user_sessions DROP FOREIGN KEY IF EXISTS fk_user_sessions_user_id;
